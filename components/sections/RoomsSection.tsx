...
function RoomCard({ room, delay }: { room: (typeof ROOMS)[number]; delay: number }) {
  ...
  return (
    <ScrollReveal delay={delay}>
      <div
        id={room.id}
        className="room-card bg-white rounded-2xl overflow-hidden border border-black/[0.04] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_48px_rgba(0,0,0,0.1)] group"
      >
